...
QT_MOC_LITERAL(3, 29, 11) // "instruction"
    ...
    "WorkerThread\0centerComputed\0\0instruction"
};
...
void WorkerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (WorkerThread::*_t)(char );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WorkerThread::centerComputed)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void WorkerThread::centerComputed(char _t1)
{
